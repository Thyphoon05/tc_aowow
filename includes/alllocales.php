...
switch($_SESSION['locale'])
{
	...
	case '6':
		mass_define(array(
			...
			// green bonuses
			'LOCALE_GBONUS_DEFENCE'				=>	'Aumenta tu índice de defensa %dp.',
			'LOCALE_GBONUS_DODGE'				=>	'Aumenta tu índice de esquivar %dp.',
			'LOCALE_GBONUS_PARRY'				=>	'Aumenta tu índice de parada %dp.',
			'LOCALE_GBONUS_SHIELDBLOCK'			=>	'Aumenta tu índice de bloqueo con escudo %dp.',
			'LOCALE_GBONUS_SPELLHIT_RATING'		=>	'Aumenta tu índice de golpe con hechizos %dp.',
			'LOCALE_GBONUS_MELEECRIT_RATING'	=>	'Aumenta tu índice de golpe crítico cuerpo a cuerpo %dp.',
			'LOCALE_GBONUS_RANGEDCRIT_RATING'	=>	'Aumenta tu índice de golpe crítico a distancia %dp.',
			'LOCALE_GBONUS_SPELLCRIT_RATING'	=>	'Aumenta tu índice de golpe crítico con hechizos %dp.',
			'LOCALE_GBONUS_SPELLHASTE_RATING'	=>	'Aumenta tu índice de celeridad con hechizos %dp.',
			'LOCALE_GBONUS_HIT_RATING'			=>	'Aumenta tu índice de golpe %dp.',
			'LOCALE_GBONUS_CRIT_RATING'			=>	'Aumenta tu índice de golpe crítico %dp.',
			'LOCALE_GBONUS_RESILIENCE_RATING'	=>	'Mejora tu índice de temple %dp.',
			'LOCALE_GBONUS_HASTE_RATING'		=>	'Aumenta tu índice de celeridad %dp.',
			'LOCALE_GBONUS_EXPERTISE_RATING'	=>	'Aumenta tu índice de pericia %dp.',
			'LOCALE_GBONUS_RESTOREMANA'			=>	'Restaura %d de mana cada 5 seg.',
			'LOCALE_GBONUS_ATTACKPOWER'			=>	'Aumenta el poder de ataque %dp.',
			...
			'LOCALE_GBONUS_HIT_TAKEN_MELEE_RATING' =>	'Mejora tu índice de evasión de golpes cuerpo a cuerpo %dp.',
			'LOCALE_GBONUS_HIT_TAKEN_SPELL_RATING' =>	'Mejora tu índice de evasión de golpes con hechizos %dp.',
			'LOCALE_GBONUS_HASTE_MELEE_RATING' =>	'Mejora tu índice de celeridad cuerpo a cuerpo %dp.',
			'LOCALE_GBONUS_RANGED_ATTACK_POWER' =>	'Aumenta tu poder de ataque a distancia %dp.',
	...
	default:
		mass_define(array(
			...
			// green bonuses
			'LOCALE_GBONUS_DEFENCE'				=>	'Increases defense rating by %dp.',
			'LOCALE_GBONUS_DODGE'				=>	'Increases your dodge rating by %dp.',
			'LOCALE_GBONUS_PARRY'				=>	'Increases your parry rating by %dp.',
			'LOCALE_GBONUS_SHIELDBLOCK'			=>	'Increases your shield block rating by %dp.',
			'LOCALE_GBONUS_SPELLHIT_RATING'		=>	'Improves spell hit rating by %dp.',
			'LOCALE_GBONUS_MELEECRIT_RATING'	=>	'Improves melee critical strike rating by %dp.',
			'LOCALE_GBONUS_RANGEDCRIT_RATING'	=>	'Improves ranged critical strike rating by %dp.',
			'LOCALE_GBONUS_SPELLCRIT_RATING'	=>	'Improves spell critical strike rating by %dp.',
			'LOCALE_GBONUS_SPELLHASTE_RATING'	=>	'Improves spell haste rating by %dp.',
			'LOCALE_GBONUS_HIT_RATING'			=>	'Increases your hit rating by %dp.',
			'LOCALE_GBONUS_CRIT_RATING'			=>	'Increases your critical strike rating by %dp.',
			'LOCALE_GBONUS_RESILIENCE_RATING'	=>	'Improves your resilience rating by %dp.',
			'LOCALE_GBONUS_HASTE_RATING'		=>	'Improves haste rating by %dp.',
			'LOCALE_GBONUS_EXPERTISE_RATING'	=>	'Increases your expertise rating by %dp.',
			'LOCALE_GBONUS_RESTOREMANA'			=>	'Restores %d mana per 5 sec.',
			'LOCALE_GBONUS_ATTACKPOWER'			=>	'Increases attack power by %dp.',
			'LOCALE_GBONUS_ARMORPENETRATION'	=>	'Increases your armor penetration rating by %dp.',
			'LOCALE_GBONUS_SPELLPOWER'			=>	'Improves spell power by %dp.',
			...
			'LOCALE_GBONUS_EXPENDABLE'					=>	'expendable',
			'LOCALE_GBONUS_HIT_TAKEN_MELEE_RATING' =>	'Improves melee hit avoidance rating by %dp.',
			'LOCALE_GBONUS_HIT_TAKEN_SPELL_RATING' =>	'Improves spell hit avoidance rating by %dp.',
			'LOCALE_GBONUS_HASTE_MELEE_RATING' =>	'Improves melee haste rating by %dp.',
			'LOCALE_GBONUS_RANGED_ATTACK_POWER' =>	'Increases ranged attack power by %dp.',
