...
switch($_SESSION['locale'])
{
	...
	case '6':
		mass_define(array(
			...
			// green bonuses
			'LOCALE_GBONUS_DEFENCE'				=>	'Aumenta tu índice de defensa %d.',
			'LOCALE_GBONUS_DODGE'				=>	'Aumenta tu índice de esquivar %d.',
			'LOCALE_GBONUS_PARRY'				=>	'Aumenta tu índice de parada %d.',
			'LOCALE_GBONUS_SHIELDBLOCK'			=>	'Aumenta tu índice de bloqueo con escudo %d.',
			'LOCALE_GBONUS_SPELLHIT_RATING'		=>	'Aumenta tu índice de golpe con hechizos %d.',
			'LOCALE_GBONUS_MELEECRIT_RATING'	=>	'Aumenta tu índice de golpe crítico cuerpo a cuerpo %d.',
			'LOCALE_GBONUS_RANGEDCRIT_RATING'	=>	'Aumenta tu índice de golpe crítico a distancia %d.',
			'LOCALE_GBONUS_SPELLCRIT_RATING'	=>	'Aumenta tu índice de golpe crítico con hechizos %d.',
			'LOCALE_GBONUS_SPELLHASTE_RATING'	=>	'Aumenta tu índice de celeridad con hechizos %d.',
			'LOCALE_GBONUS_HIT_RATING'			=>	'Aumenta tu índice de golpe %d.',
			'LOCALE_GBONUS_CRIT_RATING'			=>	'Aumenta tu índice de golpe crítico %d.',
			'LOCALE_GBONUS_RESILIENCE_RATING'	=>	'Mejora tu índice de temple %d.',
			'LOCALE_GBONUS_HASTE_RATING'		=>	'Aumenta tu índice de celeridad %d.',
			'LOCALE_GBONUS_EXPERTISE_RATING'	=>	'Aumenta tu índice de pericia %d.',
			'LOCALE_GBONUS_RESTOREMANA'			=>	'Restaura %d de mana cada 5 seg.',
			'LOCALE_GBONUS_ATTACKPOWER'			=>	'Aumenta el poder de ataque %d.',
			'LOCALE_GBONUS_ARMORPENETRATION'	=>	'Aumenta tu índice de penetración de armadura %d.',
			'LOCALE_GBONUS_SPELLPOWER'			=>	'Aumenta el poder con hechizos %d.',
			...
			'LOCALE_GBONUS_HIT_TAKEN_SPELL_RATING' =>	'Mejora tu índice de evasión de golpes con hechizos %d.',
			'LOCALE_GBONUS_HASTE_MELEE_RATING' =>	'Mejora tu índice de celeridad cuerpo a cuerpo %d.',
			'LOCALE_GBONUS_RANGED_ATTACK_POWER' =>	'Aumenta tu poder de ataque a distancia %d.',
